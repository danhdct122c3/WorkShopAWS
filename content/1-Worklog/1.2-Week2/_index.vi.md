...
|-----|-----------|--------------|-----------------|----------------|
| 2 | - Phân tích bài toán: Xây dựng hệ thống quản lý khuôn viên thông minh (Smart Campus Platform). <br> - Xác định các actor (nhân viên, sinh viên, quản lý, bảo vệ, kỹ thuật viên) và use-cases. <br> - Nghiên cứu Amazon DynamoDB: NoSQL, Single Table Design, Partition Key, Sort Key, GSI. <br> - Nghiên cứu Amazon Rekognition: IndexFaces, SearchFacesByImage, Collection. <br> - Nghiên cứu Amazon SNS: Topics, Subscriptions, Email/SMS notification. | 30/06/2026 | 30/06/2026 | https://docs.aws.amazon.com/ |
